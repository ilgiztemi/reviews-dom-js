...
window.addEventListener('DOMContentLoaded', () => {
    const page = reviews[profile];
    img.src = page.img;
    fullName.innerHTML = page.fullName;
    specialty.innerHTML = page.specialty;
    text.innerHTML = page.text;
});

function newPage(props) {
    const page = reviews[props];
    img.src = page.img;
    fullName.innerHTML = page.fullName;
    specialty.innerHTML = page.specialty;
    text.innerHTML = page.text;
...
btn.addEventListener('click', () => {
    ...
    profile = Math.floor(Math.random() * (max - min + 1)) + min;
    newPage(profile);
})
